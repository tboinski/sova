...
\subsection{Diagram}
 \scalebox{0.70}{\includegraphics{./modelowanie/OV_UML/PackageDiagram.png}}
...
\subsection{Diagram}
 ...
 \scalebox{0.12}{\includegraphics{./modelowanie/OV_UML/NodesClassDiagram.png}}
...
CN001 & Node \\ \hline
Opis: & Klasa nadrzędna względem wszystkich używanych klas obsługi wierzchołków. Zawiera definicje podstawowych pól o funkcji.    \\ \hline
Klasy nadrzędne: &     \\ \hline
Atrybuty: & \begin{itemize}
 \item strokeWidth
 \item height
...
Opis: & Klasa reprezentuje wierzchołek     \\ \hline
...
Opis: & Klasa reprezentuje wierzchołek ograniczenia OWL MaxCardinality.    \\ \hline
...
Opis: & Klasa reprezentuje wierzchołek ograniczenia OWL MinCardinality.    \\ \hline
Klasy nadrzędne: & CardinalityValueNode     \\ \hline
Atrybuty: & %\begin{itemize}
 %\item 
%\end{itemize}
...
\subsection{Diagram}
 ...
 \scalebox{0.26}{\includegraphics{./modelowanie/OV_UML/EdgeClassDiagram.png}}
...
CE001 & Edge \\ \hline
Opis: &  Klasa reprezentująca krawędź na grafie    \\ \hline
Klasy nadrzędne: &     \\ \hline
Atrybuty: & \begin{itemize}
...
Opis: &  Klasa reprezentująca na grafie relację miedzy property a klasą   \\ \hline
Klasy nadrzędne: & Edge    \\ \hline
Atrybuty: & %\begin{itemize}
 %\item 
%\end{itemize}
...
Opis: & Klasa reprezentująca na grafie właściwość property Range     \\ \hline
Klasy nadrzędne: & Edge    \\ \hline
Atrybuty: & %\begin{itemize}
 %\item 
%\end{itemize}
...
CE010 & SubEdge \\ \hline
Opis: & Klasa reprezentująca na grafie związek SubClass pomiędzy klasami   \\ \hline
Klasy nadrzędne: & Edge    \\ \hline
Atrybuty: & %\begin{itemize}
 %\item 
%\end{itemize}
...
\subsection{Diagram}
 ...
 \scalebox{0.45}{\includegraphics{./modelowanie/OV_UML/VisualizationClassDiagram.png}}
...
\subsection{Diagram}
 ...
 \scalebox{0.6}{\includegraphics{./modelowanie/OV_UML/GraphClassDiagram.png}}

...
Atrybuty: & \begin{itemize}
 ...
 \item intersubsectionOfNodeColor
...
\begin{center}
 \scalebox{0.38}{\includegraphics{./modelowanie/OV_UML/NodesClassDiagram.png}}\end{center}
...
CN013 & IntersubsectionOfNode \\ \hline
Opis: & Klasa reprezentuje wierzchołek klas anonimowych OWL będących wynikiem przecięcia (OWL IntersubsectionOf).    \\ \hline
Klasy nadrzędne: & AnonymousNode     \\ \hline
Atrybuty: & %\begin{itemize}
 %\item 
%\end{itemize}

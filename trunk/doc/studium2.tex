...
\begin{center}
 \scalebox{0.45}{\includegraphics{./elementyGraficzne/harmonogramy/sem1.png}}\end{center}
\subsubsection{Harmonogram na II semestr}
\begin{center}
 \scalebox{0.5}{\includegraphics{./elementyGraficzne/harmonogramy/sem2.png}}\end{center}

...
PW025: & hasProperty &
 \scalebox{0.25}{\includegraphics{elementyGraficzne/hasProperty3.png}} 
 %\newline
...
PW031: & cardinality &
 \scalebox{0.30}{\includegraphics{./img/cardinality.png}}
 % class.png: 194x86 pixel, 90dpi, 5.48x2.43 cm, bb=0 0 155 69
 \\ \hline


\end{longtable}
%\scalebox{0.16}{\includegraphics{./img/individual.jpg}} \\ \hline
%Projekt: & \includegraphics{myimage.png}

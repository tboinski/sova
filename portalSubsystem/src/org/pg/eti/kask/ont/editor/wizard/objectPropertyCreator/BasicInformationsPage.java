...
public class BasicInformationsPage extends AbstractPage implements ActionListener{
	...
	private JTextField inversePropertyTextField;
	...
	private JButton browseInversePropertyButton;
	...
	private void initialize() {
		...
		JLabel inversePropertyLabel = new JLabel();
		inversePropertyLabel.setText(messages.getString("inversePropertyLabel.text"));
		
		this.inversePropertyTextField = new JTextField();
		
		this.browseInversePropertyButton = new JButton();
		this.browseInversePropertyButton.setText(messages.getString("browseButton.text"));
		this.browseInversePropertyButton.addActionListener(this);
				...
				.addGroup(layout.createParallelGroup()
						.addGroup(layout.createSequentialGroup()
								.addGroup(layout.createParallelGroup()
										...
										.addComponent(inversePropertyLabel))
								.addGroup(layout.createParallelGroup()
										...
										.addGroup(layout.createSequentialGroup()
												.addComponent(inversePropertyTextField)
												.addComponent(browseInversePropertyButton))))
	...
	public boolean validate() {
		...
		String inversePropertyURI = inversePropertyTextField.getText();
		...
		if(inversePropertyURI != null && !inversePropertyURI.trim().equals("")) {
			result.setInversePropertyURI(inversePropertyURI);
		}
	...
	public void actionPerformed(ActionEvent e) {
		...
		} else if(e.getSource() == browseInversePropertyButton) {
			if(propertiesInfo != null && propertiesInfo.size() > 0) {
				inversePropertyTextField.setText(propertiesInfo.get(0).getElementURI());
			}
		}
	}

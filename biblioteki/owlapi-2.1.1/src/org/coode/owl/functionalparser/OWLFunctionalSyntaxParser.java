...
public class OWLFunctionalSyntaxParser implements OWLFunctionalSyntaxParserConstants {
  ...
  final public void Ontology() throws ParseException {
    OWLAnnotation anno;
    OWLAxiom ax;
    int count = 0;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  final public OWLImportsDeclaration ImportsDeclaration() throws ParseException {
    ...
    jj_consume_token(CLOSEPAR);
        try {
            man.loadOntology(uri);
        }
        catch(OWLOntologyCreationException e) {
            {if (true) throw new OWLRuntimeException(e);}
        }
        {if (true) return dataFactory.getOWLImportsDeclarationAxiom(ontology, uri);}
    throw new Error("Missing return statement in function");
  }

  final public void LabelAnnotation() throws ParseException {
  ...
  final public void CommentAnnotation() throws ParseException {

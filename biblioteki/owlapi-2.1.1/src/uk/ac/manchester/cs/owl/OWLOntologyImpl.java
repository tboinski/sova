...
//                    if(axiom.getProperty().equals(axiom)) {
//                        result.add(axiom);
//                    }
//                }
//
...
//        }
    ...
    public Set<OWLIndividualAxiom> getAxioms(final OWLIndividual individual) {
        ...
        for (OWLAxiom ax : getAxioms(individual, getOWLIndividualReferences(), false)) {
            ax.accept(new OWLAxiomVisitorAdapter() {

                public void visit(OWLNegativeObjectPropertyAssertionAxiom axiom) {
                    if (axiom.getSubject().equals(individual)) {
                        result.add(axiom);
                    }
                }
                ...
                public void visit(OWLDifferentIndividualsAxiom axiom) {
                    if (axiom.getIndividuals().contains(individual)) {
                        result.add(axiom);
                    }
                }
                ...
                public void visit(OWLClassAssertionAxiom axiom) {
                    if (axiom.getIndividual().equals(individual)) {
                        result.add(axiom);
                    }
                }
        ...
        public void visit(OWLSubClassAxiom axiom) {
            if (addAxiom) {
                ...
                if (!axiom.getSubClass().isAnonymous()) {
                    ...
                    addAxiomToSet(axiom, generalClassAxioms);
    ...
    private void buildAxiomAnnotationAxiomsIndex() {
        owlAxiomAnnotationAxioms = new HashSet<OWLAxiomAnnotationAxiom>();
        buildAxiomIndex(new OWLAxiomVisitorAdapter() {
            public void visit(OWLAxiomAnnotationAxiom axiom) {
    ...
    private void buildAnnotationAxiomsIndex() {
        annotationAxioms = new HashSet<OWLAnnotationAxiom>();
        buildAxiomIndex(new OWLAxiomVisitorAdapter() {
            public void visit(OWLAxiomAnnotationAxiom axiom) {

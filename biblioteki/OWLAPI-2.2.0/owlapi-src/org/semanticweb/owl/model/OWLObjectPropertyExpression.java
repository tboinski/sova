...
public interface OWLObjectPropertyExpression extends OWLPropertyExpression<OWLObjectPropertyExpression, OWLDescription> {
    ...
    /**
     * Determines if the specified ontology specifies that
     * this property is inverse functional.
     * @param ontology The ontology to be tested for an inverse
     * functional property axiom.
     * @return <code>true</code> if the property is inverse functional,
     * or <code>false</code> if the property is not inverse functional.
     */
    ...
    /**
     * If the property is a named object property then this method will
